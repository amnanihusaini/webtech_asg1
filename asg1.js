function scrollToSection() {
    const salarydeductionform = document.getElementById("salarydeductionform");
    salarydeductionform.scrollIntoView({ behavior: 'smooth' }); // Scrolls to the section smoothly
  }
